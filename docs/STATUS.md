...
`c45239625263`. Public GA still requires repeatable evidence for release
artifacts, packaging/distribution closure, and release-specific signoff.

Latest local release-candidate evidence:

- manifest:
  `.hideout-release-evidence/release-dogfood-20260704T204322Z-c45239625263/manifest.json`
- status: passed
- command: `scripts/test-phase1.sh --release-candidate`
- commit: `c45239625263`, dirty: false
