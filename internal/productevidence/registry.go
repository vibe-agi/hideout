...
func ProductHardeningRequirements() []ProofRequirement {
	rows := []ProofRequirement{
		...
		req(Feature021, Proof021WebUIBrowserConsole, LayerProductHardening, RequiredForTargetedCompletion, FreshnessSameCommit, ArtifactPolicyNone, Claim021BrowserConsole.ClaimID, "021.FR-002"),
		req(Feature021, Proof021WebUIBrowserLive, LayerProductHardening, RequiredForTargetedCompletion, FreshnessSameCommit, ArtifactPolicyNone, "021.FR-003"),
		req(Feature021, Proof021WebUIBrowserNoticeAck, LayerProductHardening, RequiredForTargetedCompletion, FreshnessSameCommit, ArtifactPolicyNone, "021.FR-004"),
		req(Feature021, Proof021WebUIBrowserAuth, LayerProductHardening, RequiredForTargetedCompletion, FreshnessSameCommit, ArtifactPolicyNone, "021.FR-005"),
		req(Feature021, Proof021TUIPTYConsole, LayerProductHardening, RequiredForTargetedCompletion, FreshnessSameCommit, ArtifactPolicyNone, "021.FR-006", "021.FR-007"),
		req(Feature021, Proof021TUIPTYLive, LayerProductHardening, RequiredForTargetedCompletion, FreshnessSameCommit, ArtifactPolicyNone, "021.FR-008"),
		req(Feature021, Proof021TUIPTYNoPolling, LayerProductHardening, RequiredForTargetedCompletion, FreshnessSameCommit, ArtifactPolicyNone, "021.FR-008"),
		req(Feature021, Proof021TUIPTYFallback, LayerProductHardening, RequiredForTargetedCompletion, FreshnessSameCommit, ArtifactPolicyNone, "021.FR-009"),
