...
- [x] T070 [US7] Keep the final ordinary-user setup fixture below Darwin's Unix-socket path limit with short owned roots, a real package PTY probe, and a static release-contract guard
