...
[ "$(grep -Ec '^\| CR045-[0-9]{3} \|' "$review_file")" -eq 13 ] ||
  fail "final code-review report does not contain exactly thirteen findings"
...
for finding_number in 001 002 003 004 005 006 007 008 009 010 011 012 013; do
